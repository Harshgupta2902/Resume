...
<head>
   ...
   <meta property="twitter:title" content="Harsh Gupta" />
...
<body class="bg-slate-900 leading-relaxed text-slate-400 antialiased selection:bg-teal-300 selection:text-teal-900">
         ...
         <div class="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
            ...
            <div class="lg:flex lg:justify-between lg:gap-4">
               <header
                  ...
                  <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
                     <li class="mr-5 text-xs">
                        <a class="block hover:text-slate-200" href="https://github.com/Harshgupta2902" target="_blank"
                           rel="noreferrer">
                     ...
                     <li class="mr-5 text-xs">
                        <a class="block hover:text-slate-200" href="https://www.instagram.com/harsh_gupta.29/"
                     ...
                     <li class="mr-5 text-xs">
                        <a class="block hover:text-slate-200" href="https://www.linkedin.com/in/harsh-gupta2901/"
                           target="_blank" rel="noreferrer">
                     ...
                     <li class="mr-5 text-xs">
                        <a class="block hover:text-slate-200" href="https://wa.me/918764485661" target="_blank"
                           rel="noreferrer">
               ...
               <main id="content" class="pt-24 lg:w-1/2 lg:py-24">
                  <section id="about" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
                     ...
                     <div>
                        <p class="mb-4">
                           ...
                           <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" href=""
                              target="_blank" rel="noreferrer">advertising agency</a>, a
                           ...
                           <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                              href="https://scout.camd.northeastern.edu/" target="_blank" rel="noreferrer">student-led
                              design studio</a>, and a
                           <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                              href="https://www.apple.com/apple-music/" target="_blank" rel="noreferrer">huge
                              corporation</a>.
                        </p>
                        <p class="mb-4">
                           ...
                           <a class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                              href="https://upstatement.com/" target="_blank" rel="noreferrer">Upstatement</a>. In my
                     ...
                     <div>
                        <ol class="group/list">
                           <li class="mb-12">
                              <div
                                 ...
                                 <header
                                    ...
                                    aria-label="Sep 2023 to Present">
                                    Sep 2023 — Present
                                 </header>
                                    ...
                                    <h3 class="font-medium leading-snug text-slate-200">
                                       <div>
                                          <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                             href="https://www.cognustechnology.com/" target="_blank" rel="noreferrer"
                                             aria-label="Flutter Developer at Cognus Technology">
                                             <span
                                                class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                             <span>
                                                Flutter Developer · Cognus
                                    ...
                                    <ul class="mt-2 flex flex-wrap" aria-label="Related links">
                                       <li class="mr-4">
                                          <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                             href="https://play.google.com/store/apps/details?id=com.mysiponline&amp;hl=en&amp;gl=US"
                                             target="_blank" rel="noreferrer">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                       ...
                                       <li class="mr-4">
                                          <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                             href="https://play.google.com/store/search?q=global+assignment+help&amp;c=apps&amp;hl=en&amp;gl=US"
                                             target="_blank" rel="noreferrer">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor" class="mr-1 h-3 w-3" aria-hidden="true">
                                                <path
                                       ...
                                       <li class="mr-4">
                                          <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                             href="https://www.gradding.com/" target="_blank" rel="noreferrer">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor" class="mr-1 h-3 w-3" aria-hidden="true">
                                                <path
                                                   d="M12.232 4.232a2.5 2.5 0 013.536 3.536l-1.225 1.224a.75.75 0 001.061 1.06l1.224-1.224a4 4 0 00-5.656-5.656l-3 3a4 4 0 00.225 5.865.75.75 0 00.977-1.138 2.5 2.5 0 01-.142-3.667l3-3z">
                           ...
                           <li class="mb-12">
                              <div
                                 ...
                                 <header
                                    class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2"
                                    aria-label="June 2023 to Sep 2023">
                                    June 2023 — Sep 2023
                                 </header>
                                 <div class="z-10 sm:col-span-6">
                                    <h3 class="font-medium leading-snug text-slate-200">
                                       <div>
                                          <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                             href="http://ixorainfotech.in/" target="_blank" rel="noreferrer"
                                             aria-label="Full-Stack Android Developer at Ixora Infotech">
                                             <span
                                                class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                             <span>
                                                Full-Stack Android Developer · Ixora
                                                <span class="inline-block">
                                                   Infotech
                                                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                      fill="currentColor"
                                    ...
                                    <ul class="mt-2 flex flex-wrap" aria-label="Related links">
                                       <li class="mr-4">
                                          <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                             href="https://play.google.com/store/apps/details?id=com.spiritual.winner&amp;hl=en&amp;gl=US"
                                             target="_blank" rel="noreferrer">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor" class="mr-1 h-3 w-3" aria-hidden="true">
                                                <path
                                       ...
                                       <li class="mr-4">
                                          <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                             href="https://play.google.com/store/apps/details?id=com.aheadly.business&amp;hl=en&amp;gl=US"
                                             target="_blank" rel="noreferrer">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor" class="mr-1 h-3 w-3" aria-hidden="true">
                                                <path
                           ...
                           <li class="mb-12">
                              <div
                                 ...
                                 <header
                                    class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2"
                                    aria-label="June 2022 to Sep 2022">
                                    June 2022 — Sep 2022
                                 </header>
                                 <div class="z-10 sm:col-span-6">
                                    <h3 class="font-medium leading-snug text-slate-200">
                                       <div>
                                          <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                             href="http://ixorainfotech.in/" target="_blank" rel="noreferrer"
                                             aria-label="Web-Developer at Ixora Infotech">
                                             <span
                                                class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                             <span>
                                                Web-Developer · Ixora
                        ...
                        <div class="mt-12">
                           <a class="inline-flex items-center font-medium leading-tight text-slate-200 font-semibold text-slate-200 group"
                              ...
                              href="http://localhost/Resume/assets/Harsh-Gupta-Resume.pdf">
                              <span>
                                 <span
                                 ...
                                 <span class="whitespace-nowrap">
                                    <span
                                       class="border-b border-transparent pb-px transition group-hover:border-teal-300 motion-reduce:transition-none">Résumé</span>
                           ...
                           <li class="mb-12">
                              <div
                                 ...
                                 <div class="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                       <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                          target="_blank" rel="noreferrer" aria-label="MySip App">
                                          <span
                                             class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                          <span>
                                             MySip
                                    ...
                                    <p class="mt-2 text-sm leading-normal">
                                       Crafted with seniority, MySIP Online is a pinnacle
                                       in investment management. Seamlessly blending
                                       Flutter's prowess, it offers intuitive SIP
                                       management, real-time tracking, robust security, and
                                       cross-platform finesse, setting a new standard in
                                 ...
                                 <img alt="" loading="lazy" width="200" height="48" decoding="async" data-nimg="1"
                                    ...
                                    src="<?php echo base_url('/assets/images/mysip.webp')?>"
                                    style="" />
                              </div>
                           </li>
                           <li class="mb-12">
                              <div
                                 ...
                                 <div class="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                       <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                          href="https://gradding.com/" target="_blank" rel="noreferrer"
                                          aria-label="Gradding">
                                          <span
                                             class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                          <span>
                                    ...
                                    <p class="mt-2 text-sm leading-normal">
                                       Exemplifying senior expertise, MyGrader is a
                                       pinnacle in academic tracking. Meticulously built on
                                       Flutter, it seamlessly combines intuitive UI,
                                       real-time progress monitoring, robust security, and
                                       cross-platform efficiency, setting a new standard in
                                       educational technology.
                                    </p>
                                    <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                       href="https://github.com/bchiang7/spotify-profile" target="_blank"
                                       rel="noreferrer" aria-label="588 stars on GitHub">
                                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                 ...
                                 <img alt="" loading="lazy" width="200" height="48" decoding="async" data-nimg="1"
                                    class="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                                    srcset="
                            undefined?url=%2Fimages%2Fprojects%2Fspotify-profile.png&amp;w=256&amp;q=75 1x,
                            undefined?url=%2Fimages%2Fprojects%2Fspotify-profile.png&amp;w=640&amp;q=75 2x
                          " src="undefined?url=%2Fimages%2Fprojects%2Fspotify-profile.png&amp;w=640&amp;q=75"
                                    style="" />
                              </div>
                           </li>
                           <li class="mb-12">
                              <div
                                 ...
                                 <div class="z-10 sm:order-2 sm:col-span-6">
                                    <h3>
                                       <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                                          href="https://www.globalassignmenthelp.com" target="_blank" rel="noreferrer"
                                          aria-label="MRP">
                                          <span
                                             class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                          <span>
                                    ...
                                    <p class="mt-2 text-sm leading-normal">
                                       An embodiment of senior expertise, the
                                       GlobalAssignmentHelp app sets a new standard in
                                       academic assistance. Crafted with precision on
                                       Flutter, it seamlessly blends intuitive design,
                                       real-time progress tracking, robust security, and
                                       cross-platform efficiency, delivering unparalleled
                                       global educational support.
                                    </p>
                                    <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                                       href="https://play.google.com/store/apps/details?id=com.globalassignmenthelp&amp;hl=en_IN&amp;gl=US"
                                       target="_blank" rel="noreferrer" aria-label="">
                                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                          class="mr-1 h-4 w-4" aria-hidden="true">
                                          <path
                                 ...
                                 <img alt="" loading="lazy" width="200" height="48" decoding="async" data-nimg="1"
                                    class="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                                    srcset="
                            undefined?url=%2Fimages%2Fprojects%2Fhalcyon.png&amp;w=256&amp;q=75 1x,
                            undefined?url=%2Fimages%2Fprojects%2Fhalcyon.png&amp;w=640&amp;q=75 2x
                          " src="undefined?url=%2Fimages%2Fprojects%2Fhalcyon.png&amp;w=640&amp;q=75" style="" />
                              </div>
                           </li>
                        </ul>
                        <div class="mt-12">
                  ...
                  <footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0"></footer>
               </main>
               <div></div>
            </div>
         </div>
   ...
   <script src="https://www.googletagmanager.com/gtag/js?id=G-4FFCWEC2WB" data-nscript="afterInteractive"></script>
</body>
